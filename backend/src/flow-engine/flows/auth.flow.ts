  ...
  states: {
    ...
    check_auth_status: {
      ...
      conditions: [
        ...
        {
          expression: 'context.phone_number && context.phone_number.length >= 10',
          event: 'has_phone',
        },
        {
    ...
    collect_otp: {
      ...
      transitions: {
        valid: 'check_profile',
        needs_profile: 'collect_name',  // Skip check_profile, go directly to name collection
        invalid: 'otp_retry',
        cancel: 'auth_cancelled',
        resend: 'send_otp',
      },
    ...
    check_profile: {
      ...
      conditions: [
        {
          expression: 'context.is_personal_info === 0 || !context.user_name || !context.user_email',
          event: 'need_name',
        },
        {
