...
export const helpFlow: FlowDefinition = {
  ...
  version: '1.0.0',
  // CLEANED UP: Removed broad triggers that caused conflicts
  // "menu" now goes to food, "options" is too generic
  // Service inquiry keywords consolidated here
  trigger: 'help|what can you do|features|what is mangwale|about mangwale|tell me about mangwale|who are you|kya hai mangwale|mangwale kya hai|chotu kya kar sakta hai',
  module: 'general',
  enabled: true,
      ...
      actions: [
        {
          ...
          executor: 'response',
          config: {
            message: "**Mangwale** is Nashik's Super App! 🚀\n\nWe're your one-stop solution for:\n• 🍕 **Food Delivery** - Order from 500+ restaurants\n• 📦 **Parcel/Courier** - Same-day delivery across Nashik\n• 🛒 **Shopping** - Groceries & local store products\n• 🏍️ **Bike Taxi** - Coming soon!\n\nHow can I help you today?",
            cards: [
              {
                id: 'card_food',
                name: 'Food Delivery',
