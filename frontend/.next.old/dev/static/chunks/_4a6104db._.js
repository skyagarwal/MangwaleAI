...
function PlacesAutocomplete({ onPlaceSelect, placeholder = "Search for a location..." }) {
            ...
            const initServices = {
                "PlacesAutocomplete.useEffect.initServices": ()=>{
                    if (window.google && window.google.maps) {
                        ...
                        console.log('✅ Places Autocomplete services initialized');
                    }
                }
            }["PlacesAutocomplete.useEffect.initServices"];
        ...
        "PlacesAutocomplete.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "PlacesAutocomplete.useEffect.timer": ()=>{
                    ...
                    const nashikCenter = new google.maps.LatLng(20.0, 73.78);
                    const nashikBounds = new google.maps.LatLngBounds(new google.maps.LatLng(19.85, 73.60), // Southwest corner
                    new google.maps.LatLng(20.20, 74.00) // Northeast corner
                    );
    ...
    const handleSelectPlace = async (placeId, description)=>{
        ...
        try {
            ...
            if (result_0.results && result_0.results.length > 0) {
...
function LocationPicker({ initialLat, initialLng, onLocationConfirm, onCancel }) {
    ...
    const [zonePolygons, setZonePolygons] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
                ...
                "LocationPicker.useEffect.fetchZones": async ()=>{
                    try {
                        ...
                        if (data.success && data.zones) {
                            ...
                            // If no position set yet and zones have center, use first zone's center
                        ...
                        // If zones fail to load and no position, use Nashik center
                        if (!position) {
    ...
    const reverseGeocode = async (lat_0, lng_0)=>{
        ...
        try {
            ...
            if (result.results && result.results.length > 0) {
                ...
                // Extract address components matching PHP backend structure
                let streetNumber = '';
                let route = '';
                place.address_components.forEach((component)=>{
                    const types = component.types;
                ...
                // Set road name (street/route)
                if (route) {
                    setRoad(route);
                }
                // Set house/building number if available
                if (streetNumber) {
            ...
            const initMap = {
                "LocationPicker.useEffect.initMap": ()=>{
                    ...
                    const mapInstance = new google.maps.Map(mapElement, {
                        ...
                        zoomControl: true,
                        zoomControlOptions: {
                            position: google.maps.ControlPosition.RIGHT_TOP // Move zoom controls to top-right
                        }
                    });
                    ...
                    markerInstance.addListener('dragend', {
                        "LocationPicker.useEffect.initMap": ()=>{
                            ...
                            if (newPos_0) {
                                ...
                                // Check if new position is in zone
              ...
              <span style="color: #10b981;">✓ Service Available</span>
                        ...
                        console.log(`✅ Drew ${polygons.length} zone boundaries on map`);
                    }
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    type: "text",
                                    value: contactName,
                                    onChange: (e_0)=>setContactName(e_0.target.value),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    type: "tel",
                                    value: contactNumber,
                                    onChange: (e_1)=>setContactNumber(e_1.target.value),
                                    className: "w-full px-4 py-3 text-base text-gray-900 bg-white border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            type: "text",
                                            value: house,
                                            onChange: (e_2)=>setHouse(e_2.target.value),
                                            className: "w-full px-4 py-3 text-base text-gray-900 bg-white border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500",
                                            placeholder: "e.g., 123"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/map/LocationPicker.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            type: "text",
                                            value: floor,
                                            onChange: (e_3)=>setFloor(e_3.target.value),
                                            className: "w-full px-4 py-3 text-base text-gray-900 bg-white border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500",
                                            placeholder: "e.g., 2nd"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/map/LocationPicker.tsx",
...
_s(LocationPicker, "DkLIOzQ9Qtm8kWAUEv4/B1TdzWE=");
_c = LocationPicker;
var _c;
