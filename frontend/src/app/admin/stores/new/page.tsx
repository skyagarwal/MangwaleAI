...
import { useAdminStores } from '@/hooks/useAdminCrud';
import { 
  ArrowLeft, Plus, Loader2, AlertCircle, Store as StoreIcon, MapPin, Clock
} from 'lucide-react';
...
export default function NewStorePage() {
  ...
  const { error, createStore, clearError } = useAdminStores();
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-purple-100 mt-2">
              Add a new store and sync to search
            </p>
          </div>
        </div>
      </div>
