...
"[project]/src/lib/api/mangwale-ai.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MANGWALE_AI_URL = ("TURBOPACK compile-time value", "http://localhost:3200") || 'http://localhost:3200';
class MangwaleAIClient {
    ...
    async sendMessage(options) {
        ...
        const sendResponse = await this.request('/chat/send', {
            method: 'POST',
            body: JSON.stringify({
                recipientId,
                text: message
        ...
        const result = await this.request(`/chat/messages/${recipientId}`);
    ...
    async getHistory(sessionId, limit = 50) {
        return this.request(`/sessions/${sessionId}/history?limit=${limit}`);
    }
    // Handle user authentication via conversation
    async authenticateUser(sessionId, phoneNumber, otp) {
    ...
    async selectModule(sessionId, module) {
        return this.request(`/sessions/${sessionId}/module`, {
            method: 'POST',
            body: JSON.stringify({
                module
            })
    ...
    async updateLocation(sessionId, lat, lng) {
        return this.request(`/sessions/${sessionId}/location`, {
            method: 'POST',
            body: JSON.stringify({
                lat,
                lng
    ...
    async handleOption(sessionId, optionId, payload) {
        return this.request(`/sessions/${sessionId}/option`, {
            method: 'POST',
            body: JSON.stringify({
                optionId,
                payload
    ...
    // Feedback
    async sendFeedback(sessionId, messageId, rating, comment) {
    ...
    async getAgentStats() {
        return this.request('/stats/agents');
    }
    async getAllFlowStats() {
        return this.request('/stats/flows');
    }
    // =====================
    // 🤖 Agents Registry
    // =====================
    ...
    async getModelsRegistry() {
        return this.request('/models-registry');
    }
    async getModel(id) {
        return this.request(`/models-registry/${id}`);
    }
    async checkModelHealth(id) {
        return this.request(`/models-registry/${id}/health`);
    }
}
const mangwaleAIClient = new MangwaleAIClient();
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/flows/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$LoadingSpinner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/shared/LoadingSpinner.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/shared/Toast.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$mangwale$2d$ai$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api/mangwale-ai.ts [app-client] (ecmascript)");
;
...
function FlowsPage() {
    ...
    const loadFlows = async ()=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$mangwale$2d$ai$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mangwaleAIClient"].getFlows();
            const flows_0 = response.flows.map((flow)=>({
                    id: flow.id,
                    name: flow.name,
            ...
            setFlows(flows_0);
            console.log(`✅ Loaded ${flows_0.length} flows from backend`);
        } catch (error) {
    ...
    const toggleFlowStatus = async (flowId)=>{
        const flow_0 = flows.find((f)=>f.id === flowId);
        if (!flow_0) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$mangwale$2d$ai$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mangwaleAIClient"].toggleFlow(flowId);
            setFlows((prev_0)=>prev_0.map((f_1)=>f_1.id === flowId ? {
                        ...f_1,
                        enabled: !f_1.enabled
                    } : f_1));
            toast.success(`Flow ${flow_0.enabled ? 'disabled' : 'enabled'} successfully`);
        } catch (error_0) {
            console.error('Failed to toggle flow status:', error_0);
            toast.error('Failed to toggle flow status');
            // Revert on error
            setFlows((prev)=>prev.map((f_0)=>f_0.id === flowId ? {
                        ...f_0,
                        enabled: flow_0.enabled
                    } : f_0));
        }
    };
    const deleteFlow = async (flowId_0)=>{
        if (!confirm('Are you sure you want to delete this flow?')) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$mangwale$2d$ai$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mangwaleAIClient"].deleteFlow(flowId_0);
            setFlows((prev_1)=>prev_1.filter((f_2)=>f_2.id !== flowId_0));
            toast.success('Flow deleted successfully');
        } catch (error_1) {
            console.error('Failed to delete flow:', error_1);
            toast.error('Failed to delete flow');
        }
    };
    const filteredFlows = selectedModule === 'all' ? flows : flows.filter((f_3)=>f_3.module === selectedModule);
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$LoadingSpinner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingSpinner"], {
            ...
            fileName: "[project]/src/app/admin/flows/page.tsx",
            lineNumber: 84,
            columnNumber: 12
        }, this);
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl p-8 text-white shadow-lg",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Design and manage conversation flows for your AI agents"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/flows/page.tsx",
                                    lineNumber: 95,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>router.push('/admin/flows/editor'),
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        modules.map((module)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: `px-4 py-2 rounded-lg text-sm font-medium transition-all ${selectedModule === module ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`,
                                children: module.charAt(0).toUpperCase() + module.slice(1)
                            }, module, false, {
                                fileName: "[project]/src/app/admin/flows/page.tsx",
                                lineNumber: 110,
                                columnNumber: 34
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: filteredFlows.map((flow_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `px-2 py-1 rounded text-xs font-medium ${flow_1.enabled ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'}`,
                                                        children: flow_1.enabled ? 'Active' : 'Inactive'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/admin/flows/page.tsx",
                                                        lineNumber: 124,
                                                        columnNumber: 19
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>toggleFlowStatus(flow_1.id),
                                        className: "p-2 hover:bg-gray-100 rounded-lg transition-colors",
                                        children: flow_1.enabled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$pause$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Pause$3e$__["Pause"], {
                                            size: 18,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            "Modified ",
                                            flow_1.lastModified.toLocaleDateString()
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/admin/flows/page.tsx",
                                        lineNumber: 149,
            ...
            filteredFlows.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: selectedModule === 'all' ? 'Create your first conversation flow to get started' : `No flows found for ${selectedModule} module`
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/flows/page.tsx",
                        lineNumber: 177,
                        columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: async ()=>{
                            try {
                                const response_0 = await fetch('http://localhost:3002/flows/templates');
                                const templates = await response_0.json();
                                console.log('Available templates:', templates);
                                toast.success(`Found ${templates.length} templates: ${templates.map((t)=>t.name).join(', ')}`);
                            } catch (error_2) {
...
_s(FlowsPage, "uidEzBXX87L9FDe/svxbUaoPsjo=", false, function() {
    return [
...
_c = FlowsPage;
var _c;
__turbopack_context__.k.register(_c, "FlowsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_371fe89a._.js.map