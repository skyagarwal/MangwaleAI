...
const navigation = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                name: 'Ecom Agent',
                href: '/admin/modules/ecom'
            },
            {
                name: 'Parcel Agent',
                href: '/admin/modules/parcel'
            },
            {
                name: 'Ride Agent',
                href: '/admin/modules/ride'
            },
            {
                name: 'Health Agent',
                href: '/admin/modules/health'
            },
            {
                name: 'Rooms Agent',
                href: '/admin/modules/rooms'
            },
            {
                name: 'Movies Agent',
                href: '/admin/modules/movies'
            },
            {
                name: 'Services Agent',
...
function AdminLayout(t0) {
    ...
    if ($[0] !== "71bc814a19467ef4081ee71d3ffff9cdd41efbb48936034888a458cdb51c2b3b") {
        for(let $i = 0; $i < 25; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "71bc814a19467ef4081ee71d3ffff9cdd41efbb48936034888a458cdb51c2b3b";
    }
    const { children } = t0;
    ...
    const [expandedItems, setExpandedItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    let t2;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "AdminLayout[toggleExpanded]": (name)=>{
                setExpandedItems({
                    "AdminLayout[toggleExpanded > setExpandedItems()]": (prev)=>prev.includes(name) ? prev.filter({
                            "AdminLayout[toggleExpanded > setExpandedItems() > prev.filter()]": (item)=>item !== name
                        }["AdminLayout[toggleExpanded > setExpandedItems() > prev.filter()]"]) : [
                            ...prev,
                            name
                        ]
                }["AdminLayout[toggleExpanded > setExpandedItems()]"]);
            }
        })["AdminLayout[toggleExpanded]"];
        $[2] = t2;
    } else {
        t2 = $[2];
    }
    const toggleExpanded = t2;
    let t3;
    if ($[3] !== sidebarOpen) {
        t3 = sidebarOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t4 = `fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`;
    let t5;
    let t6;
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t6 = ({
            "AdminLayout[<button>.onClick]": ()=>setSidebarOpen(false)
    ...
    let t8;
    if ($[8] !== expandedItems || $[9] !== pathname) {
        t8 = navigation.map({
            "AdminLayout[navigation.map()]": (item_0)=>{
                const isActive = item_0.href ? pathname === item_0.href : item_0.children?.some({
                    "AdminLayout[navigation.map() > (anonymous)()]": (child)=>pathname === child.href
                }["AdminLayout[navigation.map() > (anonymous)()]"]);
                const isExpanded = expandedItems.includes(item_0.name);
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: item_0.children ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "AdminLayout[navigation.map() > <button>.onClick]": ()=>toggleExpanded(item_0.name)
                                }["AdminLayout[navigation.map() > <button>.onClick]"],
                                className: `w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-colors ${isActive ? "bg-blue-50 text-blue-700" : "text-gray-700 hover:bg-gray-100"}`,
                                children: [
                            ...
                            isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: item_0.children.map({
                                    "AdminLayout[navigation.map() > item_0.children.map()]": (child_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: child_0.href,
                                            className: `block px-3 py-2 text-sm rounded-lg transition-colors ${pathname === child_0.href ? "bg-blue-50 text-blue-700 font-medium" : "text-gray-600 hover:bg-gray-100"}`,
                                ...
                                }["AdminLayout[navigation.map() > item_0.children.map()]"])
                            }, void 0, false, {
                                fileName: "[project]/src/app/admin/layout.tsx",
                                lineNumber: 198,
                                columnNumber: 475
                        ...
                        href: item_0.href,
                        className: `flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${isActive ? "bg-blue-50 text-blue-700" : "text-gray-700 hover:bg-gray-100"}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(item_0.icon, {
                                size: 20
                            }, void 0, false, {
    ...
    if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = ({
            "AdminLayout[<button>.onClick]": ()=>setSidebarOpen(true)
        })["AdminLayout[<button>.onClick]"];
        $[17] = t12;
    } else {
        t12 = $[17];
    ...
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-white px-6",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: t12,
                    className: "lg:hidden text-gray-500 hover:text-gray-700",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$shared$2f$Breadcrumbs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Breadcrumbs"], {}, void 0, false, {
                    fileName: "[project]/src/app/admin/layout.tsx",
                    lineNumber: 244,
                    columnNumber: 203
                }, this)
...
_s(AdminLayout, "SA+uWDJcGxW3CIRPtv0/U0oNShg=", false, function() {
    return [
...
//# sourceMappingURL=_751e5439._.js.map